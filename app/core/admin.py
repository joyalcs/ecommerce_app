...
from .models import Category, Vendor, ProductImages, Product
from .models import CartOrder, CartOrderItems, ProductReview, Wishlist, Address
...
class CartOrderItemsAdmin(admin.ModelAdmin):
    list_display = ['order', 'item', 'image', 'invoice_no',
                    'product_status', 'qty', 'total_price']
